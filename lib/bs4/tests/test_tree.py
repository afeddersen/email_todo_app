...
class TestFindAllByAttribute(TreeTest):
    ...
    def test_find_all_by_utf8_attribute_value(self):
        ...
        self.assertEqual([soup.a], soup.find_all(
            title=[peace, "something else"]))
...
"""
    ...
    def test_dashed_tag_text(self):
        self.assertEqual(self.soup.select(
            'body > custom-dashed-tag')[0].text, u'Hello there.')

    def test_select_dashed_matches_find_all(self):
        self.assertEqual(self.soup.select('custom-dashed-tag'),
    ...
    def test_attribute_endswith(self):
        self.assertSelectMultiple(
            ...
            ('link[href$=".css"]', ['l1']),
            ('link[id$="1"]', ['l1']),
            ('[id$="1"]', ['data1', 'l1', 'p1', 'header1',
                           's1a1', 's2a1', 's1a2s1', 'dash1']),
            ('div[id$="1"]', ['data1']),
            ('[id$="noending"]', []),
        )
    ...
    def test_multiple_select_direct_descendant_and_tags(self):
        self.assertSelects('div > x, y, z', [
                           'xid', 'yid', 'zida', 'zidb', 'zidab', 'zidac'])
    ...
    def test_multiple_select_attrs(self):
        self.assertSelects('p[lang=en], p[lang=en-gb]',
                           ['lang-en', 'lang-en-gb'])
