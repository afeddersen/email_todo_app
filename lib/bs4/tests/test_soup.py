...
class TestWarnings(SoupTest):
    ...
    def test_disk_file_warning(self):
        ...
        # The file no longer exists, so Beautiful Soup will no longer issue the
        # warning.
        with warnings.catch_warnings(record=True) as w:
            soup = self.soup(filename)
...
class TestEncodingConversion(SoupTest):
    ...
    def test_attribute_name_containing_unicode_characters(self):
        ...
        self.assertEqual(self.soup(markup).div.encode(
            "utf8"), markup.encode("utf8"))
...
<i>\310\322\321\220\312\321\355\344</i></html>"""
    ...
    def test_detwingle_ignores_multibyte_characters(self):
        ...
        for tricky_unicode_char in (
            ...
            # 3-byte char '\xe2\x82\x93'
            u"\N{LATIN SUBSCRIPT SMALL LETTER X}",
            # This is a CJK character, not sure which one.
            u"\xf0\x90\x90\x93",
        ):
