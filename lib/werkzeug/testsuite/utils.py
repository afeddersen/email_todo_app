...
class GeneralUtilityTestCase(WerkzeugTestCase):
    ...
    def test_import_string(self):
        ...
        self.assert_is(utils.import_string(u'cgi.escape'), cgi.escape)
        self.assert_is(utils.import_string(
            u'werkzeug.debug.DebuggedApplication'), DebuggedApplication)
        self.assert_raises(ImportError, utils.import_string,
                           'XXXXXXXXXXXXXXXX')
    ...
    def test_html_builder(self):
        ...
        self.assert_equal(xhtml.input(disabled=True),
