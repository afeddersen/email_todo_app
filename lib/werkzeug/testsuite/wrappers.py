...
class WrappersTestCase(WerkzeugTestCase):
    ...
    def test_base_request(self):
        ...
        self.assert_strict_equal(response['args'], MultiDict(
            [('foo', u'bar'), ('foo', u'hehe')]))
    ...
    def test_etag_request_mixin(self):
        ...
        self.assert_equal(request.if_modified_since,
                          datetime(2008, 1, 22, 11, 18, 44))
        self.assert_equal(request.if_unmodified_since,
                          datetime(2008, 1, 22, 11, 18, 44))
    ...
    def test_common_response_descriptors_mixin(self):
        ...
        self.assert_equal(response.vary.to_header(),
                          'Cookie, Content-Language')
    ...
    def test_common_request_descriptors_mixin(self):
        ...
        self.assert_equal(request.content_md5,
