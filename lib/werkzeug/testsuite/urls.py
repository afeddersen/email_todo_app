...
class URLsTestCase(WerkzeugTestCase):
    ...
    def test_quoting(self):
        self.assert_strict_equal(urls.url_quote(
            u'\xf6\xe4\xfc'), '%C3%B6%C3%A4%C3%BC')
        self.assert_strict_equal(urls.url_unquote(
            urls.url_quote(u'#%="\xf6')), u'#%="\xf6')
        ...
        self.assert_strict_equal(urls.url_encode(
            {b'a': None, b'b': b'foo bar'}), 'b=foo+bar')
        self.assert_strict_equal(urls.url_encode(
            {u'a': None, u'b': u'foo bar'}), 'b=foo+bar')
    ...
    def test_url_encoding(self):
        ...
        self.assert_strict_equal(urls.url_encode(
            d, sort=True), 'bar=23&blah=H%C3%A4nsel&foo=1')
        self.assert_strict_equal(urls.url_encode(
            d, sort=True, separator=u';'), 'bar=23;blah=H%C3%A4nsel;foo=1')
    ...
    def test_iri_support(self):
        ...
        self.assert_strict_equal(urls.iri_to_uri(
            u'http://☃.net/'), 'http://xn--n3h.net/')
        self.assert_strict_equal(
    ...
    def test_href_url_join(self):
        ...
        self.assert_line_equal(x(u'http://example.com/'),
